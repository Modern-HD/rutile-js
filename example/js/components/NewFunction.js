    ...
    return Rutile.build(
        ...
        <p>
            <p style="{paragraphStyle}">
                ...
                <p style="{paragraphStyle}">카운터3: ${myObj.subs(
                    s => s.count
                )} <button onClick="{onMyObjIncrement}">+1</button></p>
        ...
        ${infoOpen.subs('component', openState =>
            count.subs(
                'component',
    ...
    `,
        {
            eventPrepare: {
                ...
                onToggleInfo: () => {
                    setInfoOpen(!infoOpen.getState());
                },
                onRename: () => {
                    setName(nameInput.current.value);
                },
                onNameReset: () => {
                    Rutile.resetGlobalState(nameAtom);
                },
            },
            stylePrepare: {
